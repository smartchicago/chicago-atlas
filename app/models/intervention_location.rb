class InterventionLocation < ActiveRecord::Base
  ...
  attr_accessible :organization_name, :program_name, :hours, :phone, :tags, :categories, :address, :city, :state, :zip, :latitude, :longitude, :dataset_id, :purple_binder_url, :program_url
end
