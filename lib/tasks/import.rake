  ...
  namespace :import do
    ...
    task :chitrec => :environment do
      ...
      datasets = [
        ...
        {:category => 'Chronic disease', :name => 'Prostate cancer', :parse_token => 'prostate_cancer', :description => "", :choropleth_cutoffs => "", :stat_type => 'range, percent'},
        {:category => 'Chronic disease', :name => 'Lung cancer', :parse_token => 'lung_cancer', :description => "", :choropleth_cutoffs => "", :stat_type => 'range, percent'},
        {:category => 'Chronic disease', :name => 'Diabetes', :parse_token => 'diabetes', :description => "", :choropleth_cutoffs => "", :stat_type => 'range, percent'},
        {:category => 'Chronic disease', :name => 'HTN', :parse_token => 'htn', :description => "", :choropleth_cutoffs => "", :stat_type => 'range, percent'},
        {:category => 'Chronic disease', :name => 'Asthma', :parse_token => 'asthma', :description => "", :choropleth_cutoffs => "", :stat_type => 'range, percent'},
        {:category => 'Chronic disease', :name => 'COPD', :parse_token => 'copd', :description => "", :choropleth_cutoffs => "", :stat_type => 'range, percent'},
        {:category => 'Chronic disease', :name => 'CHD', :parse_token => 'chd', :description => "", :choropleth_cutoffs => "", :stat_type => 'range, percent'},
      ]
