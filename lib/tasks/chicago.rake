  ...
  namespace :import do
    namespace :chicago do
      ...
      task :dph => :environment do
        ...
        # year range for CDPH death statistics (this year range may change on the data portal)
        death_yr_range = '2006 - 2010'
        death_parse_token = 'average_adjusted_rate_2006__2010'
